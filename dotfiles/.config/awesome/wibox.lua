...
for s = 1, screen.count() do
    ...
    -- Mcabber widget
    mcmessages = widget({ type = "textbox", name = "mcabber" })
    mcabbtimer = timer({ timeout = 3 })
    mcabbtimer:add_signal("timeout", function() mcmessages.text = mcabber_unread() end)
    mcabbtimer:start()
    --girls = widget({ type = "textbox", name = "girl" })
    --girls.text = '<span face="SEXY SPANISH ERASMUS GIRLS V.2.0" font="22">b</span>'
